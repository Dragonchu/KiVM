...
void Field::postLinkValueType() {
  switch (_descriptor[0]) {
    case L'Z':_valueType = ValueType::BOOLEAN;
      break;
    case L'B':_valueType = ValueType::BYTE;
      break;
    case L'C':_valueType = ValueType::CHAR;
      break;
    case L'S':_valueType = ValueType::SHORT;
      break;
    case L'I':_valueType = ValueType::INT;
      break;
    case L'F':_valueType = ValueType::FLOAT;
      break;
    case L'J':_valueType = ValueType::LONG;
      break;
    case L'D':_valueType = ValueType::DOUBLE;
      break;
    case L'L': {
