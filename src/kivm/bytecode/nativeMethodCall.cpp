...
static ffi_type *valueTypeToFFIType(ValueType valueType) {
  switch (valueType) {
    case ValueType::BOOLEAN:return &ffi_type_uint8;
    case ValueType::BYTE:return &ffi_type_sint8;
    case ValueType::CHAR:return &ffi_type_uint16;
    case ValueType::SHORT:return &ffi_type_sint16;
    case ValueType::INT:return &ffi_type_uint32;
    case ValueType::FLOAT:return &ffi_type_float;
    case ValueType::LONG:return &ffi_type_sint64;
    case ValueType::DOUBLE:return &ffi_type_double;
    case ValueType::VOID:return &ffi_type_void;
    case ValueType::OBJECT:
    case ValueType::ARRAY:return &ffi_type_pointer;
...
oop JavaCall::invokeNative(bool hasThis, bool resolveTwice) {
  ...
  switch (returnValueType) {
    ...
    default:PANIC("Unknown value type: %d", returnValueType);
  }
