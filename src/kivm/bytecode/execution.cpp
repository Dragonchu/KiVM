...
typeArrayOop Execution::newPrimitiveArray(JavaThread *thread, int arrayType, int length) {
  ...
  switch (arrayType) {
    case T_BOOLEAN:arrayClass = SystemDictionary::get()->find(L"[Z");
      break;
    case T_BYTE:arrayClass = SystemDictionary::get()->find(L"[B");
      break;
    case T_CHAR:arrayClass = SystemDictionary::get()->find(L"[C");
      break;
    case T_DOUBLE:arrayClass = SystemDictionary::get()->find(L"[D");
      break;
    case T_FLOAT:arrayClass = SystemDictionary::get()->find(L"[F");
      break;
    case T_INT:arrayClass = SystemDictionary::get()->find(L"[I");
      break;
    case T_SHORT:arrayClass = SystemDictionary::get()->find(L"[S");
      break;
    case T_LONG:arrayClass = SystemDictionary::get()->find(L"[J");
      break;
    default:arrayClass = nullptr;
      break;
  }
