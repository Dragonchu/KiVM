...
JNI_ENTRY(jobject,
          CallNonvirtualObjectMethodA(JNIEnv * env, jobject obj, jclass clazz, jmethodID methodID, const jvalue
              *args)) {
  PANIC("not implemented");
}
...
JNI_ENTRY(jboolean,
          CallNonvirtualBooleanMethodA(JNIEnv * env, jobject obj, jclass clazz, jmethodID methodID, const jvalue
              *args)) {
  PANIC("not implemented");
}
...
JNI_ENTRY(jdouble,
          CallNonvirtualDoubleMethodA(JNIEnv * env, jobject obj, jclass clazz, jmethodID methodID, const jvalue
              *args)) {
  PANIC("not implemented");
}
