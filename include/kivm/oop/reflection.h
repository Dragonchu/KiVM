...
inline ValueType primitiveTypeToValueType(wchar_t c) {
  switch (c) {
    ...
    default:SHOULD_NOT_REACH_HERE_M("primitive type required");
      break;
  }
}
...
inline wchar_t valueTypeToPrimitiveType(ValueType v) {
  switch (v) {
    case ValueType::BOOLEAN:return L'Z';
    case ValueType::BYTE:return L'B';
    case ValueType::CHAR:return L'C';
    case ValueType::SHORT:return L'S';
    case ValueType::INT:return L'I';
    case ValueType::FLOAT:return L'F';
    case ValueType::LONG:return L'J';
    case ValueType::DOUBLE:return L'D';
    case ValueType::VOID:return L'V';
    default:SHOULD_NOT_REACH_HERE_M("primitive type required");
  }
}
...
inline String valueTypeToPrimitiveTypeName(ValueType v) {
  switch (v) {
    case ValueType::BOOLEAN:return L"boolean";
    case ValueType::BYTE:return L"byte";
    case ValueType::CHAR:return L"char";
    case ValueType::SHORT:return L"short";
    case ValueType::INT:return L"int";
    case ValueType::FLOAT:return L"float";
    case ValueType::LONG:return L"long";
    case ValueType::DOUBLE:return L"double";
    case ValueType::VOID:return L"void";
    default:SHOULD_NOT_REACH_HERE_M("primitive type required");
  }
}
