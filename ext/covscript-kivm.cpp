  ...
  static void csNativeCallerVoid(JNIEnv *env, ...) {
    ...
    for (auto it = descriptorMap.begin(); it != descriptorMap.end(); ++it) {
      ...
      switch (valueType) {
        ...
        default:throw cs::lang_error("cs-jni methods called without JNI environment");
      }
    }
    va_end(ap);
...
CNI_NORMAL(void, registerNative,
  ...
  switch (method->getReturnType()) {
    case ValueType::INT:NativeMethodPool::get()->set(method, (void *) &CSKiVMInstance::csNativeCallerInt);
      break;
    case ValueType::LONG:NativeMethodPool::get()->set(method, (void *) &CSKiVMInstance::csNativeCallerLong);
      break;
    case ValueType::FLOAT:NativeMethodPool::get()->set(method, (void *) &CSKiVMInstance::csNativeCallerFloat);
      break;
    case ValueType::DOUBLE:NativeMethodPool::get()->set(method, (void *) &CSKiVMInstance::csNativeCallerDouble);
      break;
    case ValueType::OBJECT:
    case ValueType::ARRAY:NativeMethodPool::get()->set(method, (void *) &CSKiVMInstance::csNativeCallerObject);
      break;
    case ValueType::VOID:NativeMethodPool::get()->set(method, (void *) &CSKiVMInstance::csNativeCallerVoid);
      break;
    default:throw cs::internal_error("should not reach here");
  }
}
